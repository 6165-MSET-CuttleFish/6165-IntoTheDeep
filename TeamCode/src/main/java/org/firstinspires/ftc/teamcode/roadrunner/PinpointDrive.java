 ...
 * Basically takes everything from normal Drive and adds pinpoint onto it
    * you'll RARELY BE WORKING WITH THIS FILE unless it's for tuning pinpoint
 */
@Config
public class PinpointDrive extends Drive {

    public static class PINPOINT_PARAMS {
        /*
        ...
        public double xOffset = 110;
        public double yOffset = -200;
    ...
    public static PinpointDrive.PINPOINT_PARAMS PINPOINT_PARAMS = new PINPOINT_PARAMS();
    ...
    public PinpointDrive(HardwareMap hardwareMap, Pose2d pose) {
        ...
        pinpoint.setOffsets(PINPOINT_PARAMS.xOffset, PINPOINT_PARAMS.yOffset);
