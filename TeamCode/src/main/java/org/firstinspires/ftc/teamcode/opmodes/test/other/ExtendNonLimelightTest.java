...
@Autonomous(name = "C - Extension Non Limelight Test")
public class ExtendNonLimelightTest extends EnhancedOpMode {
    ...
    public void onStart() {
        ...
        limelightAction = new Limelight.SearchForSample(true, true, 1);
